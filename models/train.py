...
parser.add_argument('--input_list', type=str, default='data/train_hdf5_file_list_woArea1.txt',
...
train_data = np.concatenate(train_data, axis=0)  # train_data: ndarray 16733 -> 4096 -> 9
train_group = np.concatenate(train_group, axis=0)  # train_group: ndarray 16733 -> 4096 -> 1
train_sem = np.concatenate(train_sem, axis=0)  # train_sem: ndarray 16733 -> 4096 -> 1
...
def train_one_epoch(sess, ops, train_writer):
    ...
    log_string('----')  # current_data:[ndarray 16733 4096 9] current_label:[16733 4096] shuffl
